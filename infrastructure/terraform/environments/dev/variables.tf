...
variable "environment" {
  type        = string
  description = "Environment name. This root is development."
  nullable    = false
  default     = "dev"

  validation {
    condition     = var.environment == "dev"
    error_message = "The development root must set environment=dev. Do not use workspaces to mix environments."
  }
}
...
variable "data_classification" {
  type        = string
  description = "DataClassification tag. Development uses financial-demo."
  nullable    = false

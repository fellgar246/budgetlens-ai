...
NON_FUNCTIONAL_REQUIREMENTS: list[NonFunctionalRequirement] = [
    ...
    },
    {
        ...
        "status": "implemented",
        "plans": ["02", "05", "06", "07", "08", "09", "10", "11"],
        "evidence": [
            "apps/api/src/budgetlens/seed.py",
            ".gitignore",
            "sample-data/README.md",
            "docs/DEMO.md",
            "scripts/portfolio_release.py",
            "apps/api/tests/unit/test_portfolio_release.py",
        ],
    },
    {
        "id": "NFR-PRI-002",
...
DOC_PATHS: tuple[Path, ...] = (
    ...
    REPO_ROOT / "docs" / "AI_EVALUATION.md",
